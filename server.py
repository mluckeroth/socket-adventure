...
class Server(object):
    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def room_description(self, room_number):
        ...
        # TODO: YOUR CODE HERE
        return [
            "You are in the room with a thick red shag carpet",
            "You are in the full of cleaning supplies and a stuffed bunny",
            "You are in the kitchen",
            "You are in the room with windows on the far wall, and skylights in the ceiling"
            ][room_number]
